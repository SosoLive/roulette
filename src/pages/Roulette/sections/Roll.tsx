...
const Roll = () => {
  ...
  return (
    <div className="w-[331px] md:w-[650px] flex items-center justify-center relative -mt-[175px] md:-mt-[325px] rounded-full anim">
      <img
      ...
      />
      <div
        className="absolute text-xl md:text-2xl mt-40 md:mt-[300px] flex flex-col items-center justify-center text-white cursor-pointer"
        onClick={rotate}
      >
        Select your bet
      </div>
